...
process_si_contact_form(); // Process the form, if it was submitted
	...
	<form method="post" action="<?php echo $_SERVER['REQUEST_URI'].$_SERVER['QUERY_STRING'] ?>" id="contact_form">
		...
		<p> <strong>Name*:</strong>&nbsp; &nbsp;<?php echo @$_SESSION['ctform']['name_error'] ?><br />
		...
		<p> <strong>URL:</strong>&nbsp; &nbsp;<?php echo @$_SESSION['ctform']['URL_error'] ?><br />
			<input type="text" name="ct_URL" size="35" value="<?php echo htmlspecialchars(@$_SESSION['ctform']['ct_URL']) ?>" />
		</p>
		<p> <strong>Message*:</strong>&nbsp; &nbsp;<?php echo @$_SESSION['ctform']['message_error'] ?><br />
			<textarea name="ct_message" style="width: 450px; height: 200px"><?php echo htmlspecialchars(@$_SESSION['ctform']['ct_message']);?></textarea>
		</p>
		<p>
			<img id="siimage" style="border: 1px solid #000; margin-right:15px;" src="./securimage_show.php?sid=<?php echo md5(uniqid());?>" title="CAPTCHA Image" align="left" border="0" />
			<object type="application/x-shockwave-flash" data="./securimage_play.swf?audio_file=./securimage_play.php&amp;bgColor1=#ffffff&amp;bgColor2=#ffffff&amp;iconColor=#777777&amp;borderWidth=1&amp;borderColor=#000000" height="32" width="32">
				<param name="movie" value="./securimage_play.swf?audio_file=./securimage_play.php&amp;bgColor1=#ffffff&amp;bgColor2=#ffffff&amp;iconColor=#777777&amp;borderWidth=1&amp;borderColor=#000000">
			</object>&nbsp;
			<a tabindex="-1" style="border-style: none;" onClick="document.getElementById('siimage').src='./securimage_show.php?sid='+Math.random();this.blur();return false;" href="#" title="Refresh Image">
				<img src="./images/refresh.png" title="Reload Image" onClick="javascript:this.blur();" align="bottom" border="0" />
			</a><br />
